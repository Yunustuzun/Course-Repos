...
sap.ui.define([
	...
	"ZINT_TRIAL_BINDING2/ZINT_TRIAL_BINDING2/test/flpSandbox"
	...
	return Opa5.extend("ZINT_TRIAL_BINDING2.ZINT_TRIAL_BINDING2.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "SalesHeaderSet/" + encodeURIComponent(sObjectId);
