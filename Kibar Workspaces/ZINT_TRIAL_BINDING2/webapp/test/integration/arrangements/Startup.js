sap.ui.define([
	"sap/ui/test/Opa5",
	"ZINT_TRIAL_BINDING2/ZINT_TRIAL_BINDING2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("ZINT_TRIAL_BINDING2.ZINT_TRIAL_BINDING2.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "ZINT_TRIAL_BINDING2.ZINT_TRIAL_BINDING2",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "SalesHeaderSet/" + sObjectId;
