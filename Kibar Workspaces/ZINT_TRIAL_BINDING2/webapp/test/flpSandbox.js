		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Trial Binding 2",
									"targetURL": "#TrialBinding2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TrialBinding2-display": {
								"semanticObject": "TrialBinding2",
								"action": "display",
								"description": "Trial Binding 2",
								"title": "Trial Binding 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ZINT_TRIAL_BINDING2.ZINT_TRIAL_BINDING2",
									"url": sap.ui.require.toUrl("ZINT_TRIAL_BINDING2/ZINT_TRIAL_BINDING2")
								}
							}
						}
					}
