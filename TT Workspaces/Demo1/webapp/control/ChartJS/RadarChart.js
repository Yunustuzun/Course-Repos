...
sap.ui.define([
	"sap/ui/core/Control",
	"yt/demo1/control/DataSet",
	"yt/demo1/control/Chart"
], function (Control, DataSet, ChartJS) {
	"use strict";

	var Pentagon = Control.extend("yt.demo1.control.Pentagon", {
		...
		metadata: {
			...
			aggregations: {
				...
				"dataSets": { type: "yt.demo1.control.DataSet", multiple: true, bindable: "bindable" }
			},
